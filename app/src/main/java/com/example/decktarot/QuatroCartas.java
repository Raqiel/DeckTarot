...
public class QuatroCartas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quatro_cartas);

        Integer q = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv = (ImageView) findViewById(R.id.imageView_primeira_carta_taça_quatro_cartas);

        Integer r = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv2 = (ImageView) findViewById(R.id.imageView_segunda_carta_taça_quatro_cartas);

        Integer s = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv3 = (ImageView) findViewById(R.id.imageView_terceira_carta_taça_quatro_cartas);
        ...
        View nextButton = findViewById(R.id.embaralhar_taca_quatro);
