...
public class TresCartas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tres_cartas);

        Integer q = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv = (ImageView) findViewById(R.id.primeira_carta_taca_tres);

        Integer r = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv2 = (ImageView) findViewById(R.id.segunda_carta_taca_tres);

        Integer s = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv3 = (ImageView) findViewById(R.id.terceira_carta_taca_tres);
        voltar = findViewById(R.id.button_voltar_taça_tres_cartas);



        View nextButton = findViewById(R.id.embaralhar_taca_tres);
