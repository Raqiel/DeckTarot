...
public class CincoCartas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cinco_cartas);

        Integer q = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv = (ImageView) findViewById(R.id.imageView_primeira_carta_taça_cinco_cartas);

        Integer r = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv2 = (ImageView) findViewById(R.id.imageView_segunda_carta_taça_cinco_cartas);

        Integer s = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv3 = (ImageView) findViewById(R.id.imageView_terceira_carta_taça_cinco_cartas);

        Integer t = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv4 = (ImageView) findViewById(R.id.imageView_quarta_carta_taça_cinco_cartas);

        Integer u = imagenesID[rgenerador.nextInt(imagenesID.length)];
        final ImageView iv5 = (ImageView) findViewById(R.id.imageView_quinta_carta_taça_cinco_cartas);
        voltar = findViewById(R.id.button_voltar_taça_cinco_cartas);


        View nextButton = findViewById(R.id.embaralhar_taca_cinco);
